...
| Channel             | Conifg                              |
| ------------------- | ----------------------------------- |
| ParameterMaster 001 | LED BA Transition LCH Fade          |
| ParameterMaster 002 |                                     |
| ParameterMaster 003 |                                     |
| ParameterMaster 004 |                                     |
| ParameterMaster 005 |                                     |
| ParameterMaster 006 |                                     |
| ParameterMaster 007 | LED BA Transition Strobe            |
| ParameterMaster 008 |                                     |
| ParameterMaster 009 |                                     |
| ParameterMaster 010 |                                     |
| ParameterMaster 011 |                                     |
...
| ParameterMaster 015 |                                     |
| ParameterMaster 016 |                                     |
| ParameterMaster 017 | LED BA Highlight Strobe             |
| ParameterMaster 018 |                                     |
| ParameterMaster 019 |                                     |
| ParameterMaster 020 |                                     |
| ParameterMaster 021 |                                     |
...
| ParameterMaster 025 |                                     |
| ParameterMaster 026 |                                     |
| ParameterMaster 027 | LED FR Transition Strobe            |
| ParameterMaster 028 |                                     |
| ParameterMaster 029 |                                     |
| ParameterMaster 030 |                                     |
| ParameterMaster 031 |                                     |
...
| ParameterMaster 035 |                                     |
| ParameterMaster 036 |                                     |
| ParameterMaster 037 | LED FR Highlight Strobe             |
| ParameterMaster 038 |                                     |
| ParameterMaster 039 |                                     |
| ParameterMaster 040 |                                     |
| ParameterMaster 041 |                                     |
...
| ParameterMaster 043 |                                     |
| ParameterMaster 044 |                                     |
| ParameterMaster 045 | MOV Transition Movment Speed        |
| ParameterMaster 046 | MOV Transition Prism Rotation Speed |
| ParameterMaster 047 | MOV Transition Strobe               |
| ParameterMaster 048 | MOV Transition Gobo Shake Intensity |
| ParameterMaster 049 |                                     |
| ParameterMaster 050 |                                     |
| ParameterMaster 051 |                                     |
| ParameterMaster 052 |                                     |
| ParameterMaster 053 |                                     |
| ParameterMaster 054 |                                     |
| ParameterMaster 055 | MOV Highlight Movment Speed         |
...
| 2.015     | Conifg 5                              |
| 2.016     | Conifg 6                              |
| 2.013     | Conifg 7 => Strobe                    |
| 2.018     | Conifg 8 => Sound 2 Light Sensibility |
...
| 2.035     | Conifg 5                              |
| 2.036     | Conifg 6                              |
| 2.033     | Conifg 7 => Strobe                    |
| 2.038     | Conifg 8 => Sound 2 Light Sensibility |
...
| 2.051   | Conifg 1                              |
| 2.052   | Conifg 2                              |
| 2.053   | Conifg 3 => Prism Rotaion             |
| 2.054   | Conifg 4 => Gobo Shake                |
| 2.055   | Conifg 5 => MOV Spead                 |
| 2.056   | Conifg 6                              |
| 2.053     | Conifg 7 => Strobe                    |
| 2.058     | Conifg 8 => Sound 2 Light Sensibility |
